import { ILeaveType, LeaveType } from "../models/leave-type.model";

export const findLeaveTypes = async (): Promise<ILeaveType[]> => {
  return LeaveType.find().sort({
    name: 1,
  });
};

export const findActiveLeaveTypes = async (): Promise<ILeaveType[]> => {
...
export const updateLeaveType = async (
  ...
  return LeaveType.findByIdAndUpdate(id, data, {
    new: true,
    runValidators: true,
  });
};
